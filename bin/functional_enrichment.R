...
option_list <- list(
    ...
    make_option(c("-t", "--log2fc_threshold"), type="double", default=1,
        ...
        metavar="character"),
    make_option(c("-x", "--max_size"), type="double", default=300,
        help="maximum size of the functional categories to test (default = 300)",
        metavar="character"),
    make_option(c("-n", "--min_size"), type="double", default=3,
        help="minimum size of the functional categories to test (default = 3)",
        metavar="character"),
