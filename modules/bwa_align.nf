process MAKE_BWA_INDEX {
    ...
    output:
    path '*.{amb,ann,bwt,pac,sa}', emit: bwa_idx
    path ref_genome, emit: ref_fasta
...
process COUNT_READS {
    ...
    path 'library_composition.png', optional: true, emit: libcomp_plot
    path 'library_composition_proportions.png', optional: true, emit: libcomp_plot_prop
